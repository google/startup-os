...
/*
 * CodeReviewServer is a gRPC server (definition in proto/code_review.proto)
 */

/* To run: bazel build //review_server/grpc:grpc_server_deploy.jar
 * java -jar bazel-bin/review_server/grpc/grpc_server_deploy.jar -- {absolute_path}
...
public class CodeReviewServer {
  ...
  private static final Logger logger = Logger.getLogger(CodeReviewServer.class.getName());

  private Server server;
  private String rootPath;

  CodeReviewServer(String rootPath) {
  ...
  public static void main(String[] args) throws IOException, InterruptedException {
    ...
    final CodeReviewServer server = new CodeReviewServer(args[1]);
    server.start();
